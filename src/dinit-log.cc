...
{
    do_log_cons(loglevel_t::NOTICE, "[  ", COLOR_GREEN, "OK", COLOR_RESET, "  ] ", service_name, "\n");
...
void log_service_failed(const char *service_name, bool dep_failed) noexcept
{
    ...
    do_log_cons(cons_lvl, "[  ", COLOR_RED, "FAILED", COLOR_RESET, "  ] ", service_name, "\n");
...
{
    do_log_cons(loglevel_t::NOTICE, "[  ", COLOR_RED, "STOPPD", COLOR_RESET,"  ] ", service_name, "\n");
